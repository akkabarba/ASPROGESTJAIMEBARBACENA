  ...
  function Administracion() {
    ...
    <span className="mx-2">Página {paginaUsuarios} de {Math.ceil(usuarios.length / usuariosPorPagina)}</span>
    ...
    <span className="mx-2">Página {paginaIncidencias} de {Math.ceil(incidencias.length / incidenciasPorPagina)}</span>
