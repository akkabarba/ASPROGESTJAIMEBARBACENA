          ...
          const estadoTexto = v =>
          v === 'nueva' ? 'Nueva' : v === 'en_curso' ? 'En curso' : 'Cerrada';
          const estadoClase = v =>
          ...
          return filterValue === 'mas_reciente'
          ...
          <button className="btn btn-secondary me-2" onClick={() => setModal({ abierto: false, id: null, username: '', newPassword: '' })}>Cancelar</button>
          ...
          <div className="mt-3 text-end">
          <button className="btn btn-secondary me-2" onClick={() => setModalEliminar({ abierto: false, id: null, email: '', confirmEmail: '' })}>Cancelar</button>
          <button className="btn btn-danger" disabled={modalEliminar.confirmEmail !== modalEliminar.email} onClick={handleEliminarUsuario}>Eliminar usuario</button>
          </div>
          </div>
          </div>
          </div>
